...
public class MainActivity extends AppCompatActivity {
    ...
    private void scheduleNotification(Notification notification, long delay) {
        Intent notificationIntent = new Intent(this, id.ac.id.telkomuniversity.tass.taskreminder.MainNotification.class);
        notificationIntent.putExtra(id.ac.id.telkomuniversity.tass.taskreminder.MainNotification.NOTIFICATION_ID, 1);
        notificationIntent.putExtra(id.ac.id.telkomuniversity.tass.taskreminder.MainNotification.NOTIFICATION, notification);
    ...
    private Notification getNotification(String content) {
        ...
        builder.setSmallIcon(R.drawable.ic_title);
    ...
    private void showAddDialog() {
        ...
        final View dialogView = inflater.inflate(R.layout.todo_custom_dialog, null);
